...
## GHBot v0.21.41 — current state & agent handoff brief (READ THIS FIRST)
...
1. Drop `GHBot-0.21.41.jar` into `plugins/` → restart. Console: `/gh status`, `/gh device-info`.

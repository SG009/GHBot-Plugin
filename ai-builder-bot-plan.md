...
**Version:** 4.4 (ALL phases 0–16 + 9b v2 console done; v0.21 edge-case hardening; v0.21.1–0.21.41 full history in §17; **v0.21.42 mega builds (100k block cap) + viewer action feed** — see §17; smoke **368/368**, jar `GHBot-0.21.42.jar`)

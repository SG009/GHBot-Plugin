...
- **v0.23.1 — LOGIN UX: RETURN-TO-DESTINATION — ✅** (owner report: login dumped everyone on the status page '/' instead of the chat console):
  ...
  - **Next open work (batch plan):** Phase B log auditor (warn/error digest + update radar) · Phase C eyes + good-result build pack · Phase D terraform brushes · Q1 undo drift-guard · vision auto-verify · `.mcstructure` export.

...
**Version:** 4.4 (ALL phases 0–16 + 9b v2 console done; v0.21 edge-case hardening; v0.21.1–0.21.42 full history in §17; **v0.21.43 review-feed reload-reset + vision retry** — see §17; smoke **369/369**, jar `GHBot-0.21.43.jar`)

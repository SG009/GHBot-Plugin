...
**Version:** 4.4 (ALL phases 0–16 + 9b v2 console done; v0.21 edge-case hardening; v0.21.1–0.21.40 full history in §17; **v0.21.41 session eviction + thread safety + init-order fix** — see §17; smoke **363/363**, jar `GHBot-0.21.41.jar`)
